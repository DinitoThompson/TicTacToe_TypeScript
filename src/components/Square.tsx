...
function Square({ index, onClick, player }: Props) {
  ...
  return (
    <div
      ...
      className={`h-36 border-solid border-4 shadow-lg border-slate-200 font-serif text-7xl text-center flex justify-center items-center cursor-pointer ${hoverStyle}`}
      {...{ onClick }}
    >
      <span
        data-cell-index={index}
